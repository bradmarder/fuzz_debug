...
public class Program
{
    ...
    public static sbyte[][][,, ] s_41 = new sbyte[][][,, ]{new sbyte[][,, ]{new sbyte[,, ]{{{10}}}}, new sbyte[][,, ]{new sbyte[,, ]{{{-109, -51, -97, 1, 0}}}}, new sbyte[][,, ]{new sbyte[,, ]{{{-118, -127, -29, -15, -1}}, {{-121, 0, -128, 127, -21}}}}};
    ...
    public static bool[][] s_113 = new bool[][]{new bool[]{true, false, false, false, false, false, false, false, true}, new bool[]{true, false, true}, new bool[]{true}, new bool[]{true}, new bool[]{false, false, true, false, true, true, true, false, false, true}, new bool[]{true, false, false, true, false}, new bool[]{false, false, false, true, false, false, true, false}, new bool[]{false, false, true, true, true, true, false}};
    ...
    public static ushort[][][][] s_126 = new ushort[][][][]{new ushort[][][]{new ushort[][]{new ushort[]{0}, new ushort[]{44971}, new ushort[]{0}, new ushort[]{47103}, new ushort[]{13306}}}, new ushort[][][]{new ushort[][]{new ushort[]{10425}}}};
