...
public class C0
{
    ...
    public ushort M6(I0 arg0)
    {
        ...
        this.F1 = 203;
        if (Program.M68((ushort)Program.M80(ref Program.s_118.F2, new bool[]{false, true, true, true}, new S1(13402, -585490357864467221L, 0).M103())))
        {
            new C1(-31353, 1, 65535).M66(Program.M109(ref Program.s_92, ref Program.s_67), Program.s_46[0].F0++, new S1(1, 0L, -17734).M103().M85(new C1(-21040, 10, 37977), (Program.M73()-- / (uint)((uint)(Program.s_36.F0 * 0) | 1)) / (uint)(0U | 1))) = Program.s_24.F1--;
        }
        else
        {
        ...
        {
            this.F2 = Program.M68(10);
            ref C0 var7 = ref Program.s_50;
            Program.s_67[0] = new S0(15173420472190583742UL, 1, 0, -43, 8485647390675279813L, 1, 8964251191179828883L, 1UL, 1L);
            Program.s_69 = this.F1;
            Program.M109(ref Program.s_38, ref Program.s_67);
        }

        return Program.s_106.F2;
    }
    ...
    public S0 M76(ref ushort arg0)
    {
        ...
        if (this.F2)
        {
            {
                this.F0 = this.F0;
                ref long var0 = ref Program.s_24.F6;
                var0 = var0++;
            }
        ...
        else
        {
            ...
            if (this.F2)
            {
                ...
                {
                    {
                        Program.M77(ref Program.s_23.F0, ref Program.s_28, new S1(32767, 10L, 32767), 1UL, ref Program.s_45);
                    }
                }

                arg0 = 22626;
                Program.s_42[0].F2 = (byte)Program.s_42[0].M78();
            }
            else
            {
                for (int var4 = 0; var4 < 2; var4++)
                {
                    ...
                    {
                        new S0(15075069446253655961UL, -19, 0, 18, -10L, 93, 9223372036854775807L, 1UL, 8370822742587418200L).M78();
                    }

                    Program.s_36.F7 = Program.s_59++;
                    {
                        {
                            ref I0[] var7 = ref var5[0][0, 0][0][0];
                    ...
                    Program.M77(ref this.F0, ref Program.s_28, Program.s_28, 0UL, ref Program.s_45);
                    Program.s_26 = new ushort[]{16402, 65535, 38818, 27102};
                    Program.s_41 = new sbyte[][][,, ]{new sbyte[][,, ]{new sbyte[,, ]{{{15, 127, -67}}}}, new sbyte[][,, ]{new sbyte[,, ]{{{-1, -2, -115}}}, new sbyte[,, ]{{{-115, -2, 127}}}, new sbyte[,, ]{{{0, 127, -97}}}, new sbyte[,, ]{{{-128, 10, 0}}}, new sbyte[,, ]{{{-82, -26, 1}}}}, new sbyte[][,, ]{new sbyte[,, ]{{{-2, 1, -20}}}, new sbyte[,, ]{{{78, 18, 126}}}, new sbyte[,, ]{{{-86, 126, 124}}}}, new sbyte[][,, ]{new sbyte[,, ]{{{-127, 127, -20}}}}, new sbyte[][,, ]{new sbyte[,, ]{{{-23, 127, 5}}}}, new sbyte[][,, ]{new sbyte[,, ]{{{1, -127, 32}}}, new sbyte[,, ]{{{-46, 40, 1}}}, new sbyte[,, ]{{{-71, 0, 0}}}, new sbyte[,, ]{{{0, 40, 127}}}, new sbyte[,, ]{{{0, 95, 68}}}, new sbyte[,, ]{{{127, 0, -15}}}}, new sbyte[][,, ]{new sbyte[,, ]{{{-128, -47, -127}}}, new sbyte[,, ]{{{-127, 7, -107}}}}, new sbyte[][,, ]{new sbyte[,, ]{{{0, -128, 0}}}}, new sbyte[][,, ]{new sbyte[,, ]{{{126, -8, -90}}}, new sbyte[,, ]{{{-83, 92, -2}}}, new sbyte[,, ]{{{82, 77, 109}}}, new sbyte[,, ]{{{25, 10, -127}}}}};
                }

                Program.s_70 = this.F2;
                this.F1 = 1;
            }
        ...
        return new S0(18446744073709551614UL, 10, 0, 0, -4373351590243669723L, 0, 3088693052499383971L, 13240373538600680174UL, 9223372036854775807L);
    }
    ...
    public I0 M94()
    {
        ...
        if (this.F2)
        {
            ...
            {
                Program.s_39 = new S0(18446744073709551614UL, 15, 192, 75, -5938994016038102273L, 1, 2171655967396636522L, 1UL, 0L);
                Program.s_77 = 0UL;
            }
        ...
        this.F2 = Program.s_58 != (ushort)(-Program.s_19--);
        if (this.F2)
        {
            this.F2 = this.F2;
            {
        ...
        {
            this.F2 = false;
            Program.M95(207, new int[]{-2147483647, 260481869, -2147483647, 0, -2147483647, 1390480096, 0, -2147483648});
        }
...
public struct S0 : I0
{
        ...
        if (1 >= this.F1)
        {
            ...
            var0 = arg0.F2;
            {
                ...
                if (!(false && !!!(this.F7 == 459540054U)))
                {
                    ...
                    this.F1 = this.F1++;
                    {
                        arg0.F2 = (short)(this.F5 / (int)(-1854335250 | 1));
                        Program.M8(this.F5, new S1[]{new S1(1, 0L, -32651), new S1(-2, 4153905687893182456L, -32767), new S1(-27841, 1L, 429), new S1(-8975, 0L, -10), new S1(353, -1L, 32767), new S1(32767, -4548170426355530173L, 1), new S1(30415, -7522895903114258025L, 32767), new S1(0, 272889559107778875L, 18886), new S1(24976, -9223372036854775807L, 32767), new S1(32767, -9223372036854775808L, -19507)}, new ulong[]{1UL, 1UL, 6335212573939983157UL, 0UL, 2UL, 18446744073709551614UL});
                        Program.s_83 = new uint[]{4294967295U, 645027421U, 3730096001U};
                        this.F8 = Program.s_73.F4;
                    }
                ...
                {
                    this.F0 = (ulong)new C1(-7820, 0, 38829).M10();
                    Program.M75() = new C0(-2, 178, false);
                    Program.s_84 = new C0(102, 255, true).M43(452201802);
                    this.F0 = Program.s_36.F0;
                }
            ...
            else
            {
                ...
                {
                    var5.F0 = 32766;
                    Program.s_86 = new C0(126, 182, false);
                }

                {
                    Program.M75() = Program.s_31;
                }
            ...
            if (new C1(1, 65535, 8542).M22(new S0(17866423857382284257UL, 1, 180, -1, 1L, 1, -3912236660122176733L, 5151005361464159020UL, 5756173183438546356L)))
            {
                ...
                else
                {
                    ...
                    if (Program.M24())
                    {
                        ...
                        new S0(1UL, 1, 1, -79, 0L, 89, 8623779039062147240L, 16878581591365171483UL, 0L).M91(-929130767);
                        Program.M62(1U, var16, var16.F1, ref Program.s_112, var16, Program.M115(Program.s_12));
                        arg0.M87(ref Program.s_84.F1);
                        Program.M67(arg0, Program.M77(ref this.F1, ref arg0, arg0, this.F0, ref Program.s_95), new C0[][]{new C0[]{new C0(0, 97, true), new C0(42, 0, true)}, new C0[]{new C0(-127, 22, false), new C0(1, 0, true), new C0(10, 1, true), new C0(-43, 254, false), new C0(1, 1, true)}}) = arg0.M45();
                        this.F0 = (ulong)Program.M42();
                    }
                    else
                    {
                        var17 = Program.s_53;
                    ...
                    Program.M71(new S0(18446744073709551614UL, -61, 239, -127, 4443012874082964377L, 255, -3554851294306689806L, 1UL, -9223372036854775807L), Program.s_107--, Program.s_32[0], this.F1, new long[][]{new long[]{-6633093534521470009L, 8903771486527089876L, 6874561332213486341L, 2378938581855101550L}, new long[]{10L, 0L, 6466114588862061248L}}, Program.s_54[0]--, ref Program.s_75) = new C1(0, 1, 63379);
                    try
                    {
                        {
                            this = this;
                            ...
                            arg0 = Program.s_18;
                            Program.M114(ref Program.s_9, new I0[]{new S0(18446744073709551615UL, -71, 0, 127, -910144368184582374L, 0, 2L, 1UL, 1L), new S0(17975577477604621416UL, 2, 0, -127, 2L, 14, 9223372036854775806L, 18446744073709551615UL, -9223372036854775808L), new S0(6787195361545434355UL, 122, 0, 1, -8677396095821781705L, 1, 1L, 0UL, 1774932758562635920L), new S0(1UL, -97, 10, -34, 9223372036854775807L, 10, -1L, 0UL, 9223372036854775806L), new S0(18150568498912449316UL, 19, 64, -73, -8636007492149593872L, 255, 5109226817428225829L, 8062615564811570803UL, -4867543506726320000L), new S0(1UL, 6, 10, -6, 2L, 56, -7693329001610612245L, 15520998576806657142UL, 0L), new S0(729830526296410655UL, 1, 240, 2, -880833027263419008L, 1, 7940783174254957943L, 1UL, 0L), new S0(12911011631286389056UL, -58, 6, 2, 2011217838407073341L, 0, -9223372036854775807L, 6473519596273545028UL, -6391532229289876803L), new S0(13593317270888254692UL, 127, 101, 127, 9223372036854775807L, 254, -10L, 18446744073709551615UL, 5738369362092065537L)}, this.F1--, new uint[, ]{{4285738271U, 3479312187U, 1U, 503421307U, 2081016510U, 1463018294U}, {1U, 0U, 1U, 2256973768U, 2371052334U, 1178069311U}, {155443361U, 0U, 4294967294U, 1089097375U, 2844981941U, 2021449794U}, {0U, 1U, 0U, 0U, 0U, 4294967294U}, {3915574978U, 0U, 2037997536U, 0U, 1460428073U, 2787475214U}, {4137501612U, 1U, 3699530135U, 4294967294U, 1834862692U, 1U}}, 0);
                        }
                    }
                    finally
                    {
                        this.F8 = 1309121068157345787L;
                    }

                    this.M74(ref Program.s_27, -4260754816959585991L);
                    Program.M58(Program.s_42[0]);
                    new C1(12199, 65534, 28793).M21();
                }
            ...
            {
                {
                    ...
                    Program.M80(ref arg0.F0, Program.M58(new S0(3534829569458033828UL, 10, 1, -26, 9223372036854775806L, 1, -10L, 0UL, 5838409968272159331L)), new S0(1UL, 1, 9, 1, -2482561825787614713L, 0, 8493813820323574598L, 8798340552222876418UL, 1L));
                    Program.s_120 = -~this.F4;
                }

                if (Program.s_113[0][0])
                {
                    Program.s_117.M16(arg0.F0, (long)this.M91(815322750));
                    Program.M92();
                }
                else
                {
                ...
                Program.s_121 = new C1(1, 22618, 12964);
                ref uint var26 = ref Program.s_97;
            }

            this.F4 += this.F8;
        }

        this.F7 = 16663719150161828143UL;
        this = Program.s_16.M108(Program.s_54[0], 0U);
        Program.M86();
        return arg0.F1;
    }
    ...
    public ref bool M82(int arg0, sbyte[] arg1, ref uint arg2)
    {
        ...
        if (Program.s_50.F2)
        {
            ...
            arg1[0] = (sbyte)Program.M84(this.F2, (uint)Program.M84(Program.s_71, 3367715445U, new S0(1UL, 127, 254, 72, 3092562237219758036L, 1, 0L, 18446744073709551614UL, -9223372036854775807L), false), Program.s_56, Program.s_29[0, 0, 0]);
        }
...
public struct S1
{
    ...
    public sbyte M29(short arg0, sbyte arg1)
    {
        ...
        finally
        {
            if (!(Program.s_6.F7 >= ~~Program.s_4))
            {
                ...
                var2 = new sbyte[][]{new sbyte[]{-128, 127, -2, 126, -83}, new sbyte[]{1, 1, 109}};
                {
                    ...
                    this = this;
                    this.F1 = this.F1--;
                    Program.s_20 |= Program.M30(ref Program.s_21);
                }
                ...
                {
                    Program.s_21[0][0, 0] = new C0(-12, 1, true);
                }
            }

            Program.M32();
            Program.s_9 = Program.s_22;
        }
        ...
        {
            var5[0] = Program.s_27[0].F0;
            Program.M42();
        }

        var6.F2 = false;
        this.F2 = (short)(~(short)(-this.F0));
        Program.M39();
        return -61;
    }
    ...
    public ref int M98(S1 arg0, short arg1, uint[, ] arg2, ulong arg3, int arg4)
    {
        ...
        Program.s_79.F0 = arg1;
        {
            ...
            this = new S1(-2, -8614771856396192845L, 7285);
            Program.s_47 >>= 10;
            arg0.F0 = (short)(arg3-- - Program.s_6.F2++);
        }
        ...
        new C1(32766, 1, 1902).M99(arg2[0, 0]);
        {
        ...
        {
            ref bool var9 = ref Program.s_94;
            Program.s_30 = 1953970950U;
            var7 = var7;
            try
            {
                arg3 = arg3;
            ...
            if (var9)
            {
                ...
                if (var9)
                {
                    arg0.F1 = (long)((ushort)(arg3 / (byte)(var7 | 1)) * var8);
                }
...

        {
            ...
            {
                new C1(26617, 2584, 64568).M99(Program.s_75[0, 0, 0]) = this.F0;
            }

            this.F0 = this.F2++;
            arg4 = arg4++;
            ref S0 var17 = ref Program.s_89;
        }
    ...
    public S0 M103()
    {
        ...
        if (Program.s_78)
        {
            ...
            {
                Program.s_42[0].F6++;
                Program.s_93 = Program.s_17.F1;
                this.F1 = Program.s_24.F4;
                this.F2 = 24947;
            }
            else
            {
...

            {
                ...
                this.F0 = Program.s_46[0].F0++;
                this = this;
                var7.F2 = 1;
                return new S0(4049974546219990362UL, 1, 157, 64, -1L, 255, 0L, 1UL, 5272482449405007080L);
            }
        }
        else
        {
            Program.s_53 = Program.s_88[0];
        }
    ...
    public uint[, ] M116(short arg0, short arg1, ref sbyte arg2)
    {
        ...
        for (int var1 = 0; var1 < 2; var1++)
        {
            ...
            Program.s_5[0][0, 0, 0].F2 = (ushort)(16434335527960961046UL >> this.F2++);
        }
        ...
        for (int var2 = 0; var2 < 2; var2++)
        {
            ...
            {
                arg1 |= arg1;
                arg1 = Program.s_118.F0;
                Program.s_116 = this.F1;
                Program.s_123 = (short)(~this.F2++);
            }
            else
            {
        ...
        {
            {
                ...
                try
                {
                    ...
                    if (var4[0].F2)
                    {
                        ...
                        if (var4[0].F2)
                        {
                            ...
                            Program.s_124 = 65212;
                            Program.s_21[0][0, 0].F2 = var4[0].F2;
                            Program.s_125 = Program.s_125;
                            var4[0] = new C0(1, 255, true);
                        }
                        else
                        {
                            Program.M117() = this.F1;
                            ref byte var7 = ref var4[0].F1;
                        }
                    ...
                    if (var4[0].F2)
                    {
                        ...
                        {
                            this.F1 = this.F1;
                            Program.s_27[0] = var4[0];
                            Program.M118();
                            Program.M118();
                            ref C1 var19 = ref Program.s_121;
                            arg0 = arg0;
                            Program.M118();
                            var4[0].F1 = (byte)Program.M117();
                            arg1 = -10;
                            Program.s_14 = Program.s_14;
                        }
                ...
                {
                    {
                        Program.s_127 = Program.s_101[0, 0];
                        Program.M118();
                    }
                }
...
public class C1
{
    ...
    public bool M18(bool[] arg0, byte arg1)
    {
        ...
        {
            this.M19(ref arg1) = Program.s_5[0][0, 0, 0];
        }
        ...
        {
            {
                ...
                try
                {
                    if (arg0[0])
                    {
                        ...
                        arg0[0] = !arg0[0];
                        this.F2 = (ushort)(-this.F2);
                        Program.s_5[0][0, 0, 0] = new C1(20503, 65534, 10);
                        Program.s_7 = -26;
                    }
                    else
                    {
                        Program.s_8 = Program.s_8;
                    }
                }
                finally
                {
                    ref ulong var12 = ref var0;
                }
            }
            ...
            finally
            {
                ...
                {
                    var13 = var13;
                    Program.M20(this).M19(ref var13.F1) = new C1(Program.s_5[0][0, 0, 0].F0, 53980, this.F2);
                    ref bool[] var19 = ref arg0;
                    ref S1 var20 = ref Program.s_1[0];
                }
            }

            Program.s_5[0][0, 0, 0].F0 = Program.s_1[0].F0;
        }
    ...
    public long[, ] M31()
    {
        ...
        try
        {
            ...
            if (Program.s_16.F2)
            {
                ...
                if (false ^ !(Program.s_6.F5 > Program.s_1[0].F2++))
                {
                    ...
                    var0 = var0;
                    {
                        ...
                        var1.F0 = var1.F0--;
                        Program.M32();
                        Program.s_28 = new S1(-32768, (long)Program.M32(), (short)(10 % (uint)(var0 | 1)));
                        var1.F0 = -71;
                ...
                {
                    this.F1 = (ushort)new S1(9317, -3256804299575785770L, -2408).M37(ref Program.s_5[0][0, 0, 0], 8220561327722984727L);
                    this.F0 = this.F0;
                }
            }

            Program.s_29 = new bool[,, ]{{{false, false, true, true, true, true, true, false, true}, {false, false, true, false, true, true, false, true, false}}, {{false, true, true, false, false, false, false, true, false}, {true, false, true, false, false, true, false, false, true}}, {{true, false, true, false, false, false, true, true, true}, {false, true, false, false, true, true, true, true, false}}, {{true, false, true, true, false, true, true, false, false}, {false, false, false, false, false, true, true, true, true}}, {{false, false, true, false, true, false, true, true, false}, {true, false, true, true, false, false, true, true, false}}, {{false, false, true, false, true, false, false, false, true}, {false, true, false, false, true, true, false, false, true}}, {{false, false, false, false, true, false, false, true, false}, {true, false, false, true, false, false, false, false, false}}, {{false, true, true, false, true, false, true, true, false}, {true, true, true, false, true, true, true, false, true}}};
            Program.s_30 %= (uint)(Program.s_25[0][0]++ | 1);
            if (Program.s_27[0].F2)
            {
                this.F2 = 33095;
                this.F0 = Program.s_28.F0;
                for (int var5 = 0; var5 < 2; var5++)
                {
            ...
            else
            {
                ...
                {
                    var7 = false;
                    Program.s_5[0][0, 0, 0].F0 = (short)(~this.F0);
                    Program.s_22 = !(-40 == Program.M42());
                    Program.M40((short)Program.M33());
                    Program.s_31 = Program.s_16;
                    this.F2 ^= (ushort)Program.s_18.M37(ref Program.s_5[0][0, 0, 0], Program.s_24.F4);
        ...
        finally
        {
            if (!(this.F0 <= (uint)Program.M42()))
            {
                ...
                for (int var16 = 0; var16 < 2; var16++)
                {
                    ...
                    var15 = Program.s_14;
                    var15 = Program.s_14;
                    Program.s_28.M37(ref Program.s_32[0], 9223372036854775807L);
                    this.F1 = this.F2;
        ...
        return new long[, ]{{10L, 3912963980037299526L, 3819160500919441656L}, {-5009221762786096456L, 9223372036854775807L, 5871099264516495381L}, {-6381072336964830232L, 1400292081457241849L, -215216959896088623L}, {-5135695611546871487L, 3791146962152857487L, 8898952776609161573L}, {-8814634313309994184L, 1L, -9223372036854775808L}, {0L, 1L, -214072775319796818L}};
    }
    ...
    public ulong M49(byte arg0)
    {
        ...
        {
            this.F2 = this.F1;
            this.F0 |= Program.s_5[0][0, 0, 0].F0;
            ref C0 var0 = ref Program.s_27[0];
            var0.F0 = 8;
        }
        else
        {
        ...
        ref sbyte[][][,, ] var4 = ref Program.s_41;
        Program.s_6.F2 = arg0;
        Program.s_42 = new S0[]{new S0(1UL, 15, 94, -69, -5382985326599727237L, 230, 8593672640932537712L, 7245937369945222275UL, -2088875282825020741L), new S0(5500388889527418877UL, -19, 254, 100, 0L, 1, 72298087118401817L, 16165880054326550817UL, 9223372036854775807L), new S0(15726650690875788498UL, -108, 10, -127, -1454041309892327680L, 1, -1958302894944194832L, 0UL, -1L), new S0(0UL, 10, 166, 44, 9223372036854775806L, 244, 5518331178941098928L, 2UL, 0L), new S0(2936664341173037172UL, 0, 1, -2, -1L, 10, 1259822798412589042L, 253724837340751335UL, 6711434002457510850L)};
        if (!new S1(-23683, -1285938429768434030L, -23528).M50(this, Program.s_12))
        {
            var4[0] = var4[0];
            arg0 = 255;
            try
            {
                this.F1 = Program.s_46[0].F1;
            }
            finally
            {
            ...
            {
                Program.s_36.F5 = (byte)(-(byte)Program.s_23.M52(var4[0][0][0, 0, 0], 0U, new sbyte[]{0, 43, -111, -1, 0, -26, 0, -127}, ref Program.s_12, ref Program.s_46));
            }
        }
    ...
    public sbyte M64()
    {
        ...
        for (int var0 = 0; var0 < 2; var0++)
        {
            ...
            Program.s_80 = Program.s_80++;
            if (Program.M68(new C1(18450, 2, 2).M65()))
            {
                ref S1 var8 = ref Program.s_1[0];
                Program.s_73.F1 = (sbyte)Program.M70(this.F0);
                --this.F2;
                if (Program.M68(Program.s_46[0].F1))
                {
                    try
                    {
                        for (int var9 = 0; var9 < 2; var9++)
                    ...
                    this.M66(new ushort[]{47127}, Program.s_46[0].F0, new C1(Program.s_53.F0++, this.F1--, 45148));
                    var8.F1 = Program.s_18.F1;
                    var12 = var12;
                    Program.s_34 = Program.s_63;
                    Program.M71(Program.s_24, 1U, this, (sbyte)(208 * this.F1--), new long[][]{new long[]{6823398184546840019L, -9223372036854775807L, 2L, 3102525348535669230L}, new long[]{-476943738456171072L, -9223372036854775808L, -9223372036854775807L, 0L, 445259447803310948L, -9223372036854775808L}, new long[]{0L, 1L, 9223372036854775807L, 2832057177807379812L, 0L}, new long[]{2521760637977552498L, 0L}, new long[]{-8679080923063234520L, 7267143583994588372L, 1L, -7473038234838607107L, 1L, 1L}, new long[]{7425357683006154969L}, new long[]{-8613152730610519860L, 9223372036854775806L}}, 877898162U, ref Program.s_75) = new C1(17590, 65535, 25303);
                    var8.F1 &= (long)new S0(12609296620210913049UL, -10, 254, 1, -9223372036854775807L, 255, -9223372036854775807L, 10340593850471241883UL, -244599910856190305L).M78();
                ...
                {
                    var16.F1 = Program.s_73.F5;
                    var16 = Program.M75();
                }

                Program.s_81 = (uint)this.M65();
            }
        }

        this.F2 = this.F2--;
        return (sbyte)Program.M77(ref Program.s_24.F1, ref Program.s_79, Program.s_1[0], Program.s_4, ref Program.s_45);
    }
...
public class Program
{
    ...
    public static void M0()
    {
        ...
        if ((false && !new C1(20828, 20105, 1).M1(76, 10268, s_1[0].M9())) || new S1((short)(44466 & s_111[0, 0, 0]), 962077397188824700L, s_28.F0++).M81())
        {
            s_24.F4 = -5553233260124854370L;
            if (!s_31.F2)
            {
                {
                    s_73.F6 = 7432363566717283280L;
                }

                s_46[0].F0 = (short)(194 >> (short)(-s_130));
                s_46[0].F0 = (short)M30(ref s_21);
                try
                {
                    s_84.F0 = -127;
                }
            ...
            M11(false, s_113, new ushort[]{65535, 64634, 43030, 1, 38115, 26354}, s_107++);
            s_131++;
        }

        M70(s_79.F0);
        M109(ref s_38, ref s_67);
        s_89.M85(s_106, 4138583570277115683UL);
        if (M95((byte)(~(byte)M92()), new int[]{-1015294204, -10, 1961544300, -2, -2147483647, 1645518238}).M18(M58(new S1(18001, -3169471304458368753L, 32767).M103()), (byte)M48(ref s_50, M26(s_42[0]), s_5[0][0, 0, 0].M69(), ref s_66)) && false)
        {
            s_50 = new C0(-128, 255, true);
        }
        else
        {
            s_82 = s_16.F1;
    ...
    public static long M8(byte arg0, S1[] arg1, ulong[] arg2)
    {
        ...
        if (s_2[0])
        {
            arg2 = new ulong[]{12703331374043799404UL, 11650213681608129569UL, 14094544422223495246UL, 3519775463542506602UL, 2UL, 3890365672877013952UL, 4228257223176196818UL, 0UL, 1UL};
            s_1 = arg1;
            if (s_2[0])
            {
                {
            ...
            {
                arg2[0] = 12011499907481787914UL;
                {
                    for (int var10 = 0; var10 < 2; var10++)
                    {
                        arg2[0] = (ulong)M11(!s_2[0], new bool[][]{new bool[]{true, true}, new bool[]{true, false, true, true, false}, new bool[]{true, false, true, false, true, false, false, false}, new bool[]{false, true, false, false, false, true, false, false, true}, new bool[]{true}, new bool[]{true, false}, new bool[]{false, false, false, false, false, false, true, true}, new bool[]{false, true, false}, new bool[]{false, false, true, false, true, false, false, true, false}, new bool[]{true, true, false, false, false, true, false, true}}, new ushort[]{23027, 46844, 53388}, arg1[0].M12());
                        s_5[0][0, 0, 0].F0 = arg1[0].F2++;
                    }
                }
            }

            {
                ...
                if (new C1(32766, 51168, 1).M18(new bool[]{false, false, false, true, false, false, false, true}, arg0))
                {
                    arg1[0].F2 = arg1[0].F0++;
                }
                else
                {
                    new C1(3894, 40943, 0).M19(ref var18.F1) = M20(new C1(-2305, 0, 65534));
                    arg2 = new ulong[]{7986652722998912232UL, 11124022159023322974UL};
                }

                s_9 = s_9;
            }

            return 5963244304701984237L;
        }

        arg1[0].F1 = -9223372036854775807L;
        new C1(0, 34314, 56336).M21().M15();
        s_6.F4 = ~arg1[0].F1++;
        if (arg2[0]++ != arg0)
        {
            arg2[0] = ~s_6.F0;
            ...
            if (new C1(-9676, 39229, 1).M22(new S0(0UL, 65, 1, 74, 1766853701178920710L, 1, -2174314084343247171L, 4739338794433684380UL, -7587941578835308517L)))
            {
                ...
                finally
                {
                    s_6.F2 = arg0;
                    s_6.F6 = arg1[0].F1;
                    s_18 = M26(new S0(5790751670939419027UL, 1, 53, -108, 3114713899701194970L, 255, -525760419796506275L, 3184815577672924814UL, -5989298213640549757L));
                }
        ...
        {
            {
                ...
                arg2[0] = arg2[0];
                if (new S0(1205424745612204156UL, -78, 145, 92, 0L, 159, -7492443338581122686L, 18446744073709551615UL, 0L).M55().M50(s_5[0][0, 0, 0], s_30++))
                {
...

            {
                ...
                {
                    arg2 = new S1(arg1[0].F2, (long)M35(ref s_21[0][0, 0].F1), (short)new S1(32766, 1L, 2007).M12()).M63(arg0, s_42[0].F3, new C0(-125, 252, true));
                }
            }
        }

        return 1244070098057009563L;
    }
        ...
        long var5 = default(long);
        {
            ...
            for (int var0 = 0; var0 < 2; var0++)
            {
...

                {
                    ...
                    if (!s_21[0][0, 0].F2)
                    {
                        s_37 = (long)new C1(541, 14215, 1).M28();
                        arg0 = arg0;
                    }
                    else
                    {
                ...
                M39();
                M58(new S0(1UL, 124, 10, 0, -5963510683806957436L, 0, 3364181277670229819L, 15739484739735240477UL, -530276279095996756L)) = s_2;
            }
        }

        if (s_5[0][0, 0, 0].M60())
        {
            return new S1(-32768, -1037955543263402911L, -6625);
        }

        s_53 = new C1(s_53.F0++, (ushort)(new S1(-6786, 2L, -2).M29((short)new S1(-32768, 104886182270466534L, 32766).M37(ref s_46[0], -10L), (sbyte)(-s_24.F1)) ^ 1), M59());
        return new C0(-86, 205, true).M61(ref s_15, new I0[, ]{{new S0(1033026089425550632UL, 76, 116, 1, 5712401193654534342L, 82, -23779676534787757L, 10684869783820264038UL, 3363915066275142320L), new S0(0UL, -127, 0, -2, 9223372036854775807L, 255, -2397348575277477474L, 1UL, 2L), new S0(18446744073709551615UL, -12, 1, -77, -3050778155631747829L, 1, 3187295340785125219L, 1UL, 0L), new S0(6777628390819843461UL, -59, 197, 1, 6194136379637820830L, 254, -3249132785827879498L, 12193844990090309317UL, -5465721169150150409L), new S0(0UL, -127, 1, -112, -3387840479952135221L, 115, 632506197873755833L, 7995995351144211421UL, -7098544997499912876L), new S0(1UL, 88, 1, 1, 10L, 255, 0L, 14370788242783880716UL, 2L), new S0(15279070301597548321UL, 0, 254, -128, -2328927145270433114L, 1, -10L, 0UL, -4119147454575130888L), new S0(17367849069499893369UL, -53, 18, -39, -9223372036854775808L, 52, 7390993931501913543L, 1UL, -9090740844905731121L)}, {new S0(1UL, -50, 255, 1, 1L, 1, -7564877161253082466L, 1UL, 1L), new S0(1UL, -127, 21, 1, 0L, 255, 1705600023407740224L, 10UL, -7267356958730130563L), new S0(1UL, 1, 239, 49, 9223372036854775807L, 1, 9223372036854775807L, 0UL, 1L), new S0(1UL, 120, 1, -57, -411948941118080894L, 123, -8152158855096293487L, 17968464497192480415UL, 2950092690650001929L), new S0(18446744073709551615UL, 0, 222, 54, 9223372036854775806L, 153, 1L, 5636383110190892850UL, 0L), new S0(1UL, 126, 203, -65, 6922603873012532159L, 0, -5238350184407843746L, 0UL, 0L), new S0(1UL, 126, 27, -128, -5236821681708586934L, 201, 9223372036854775807L, 1UL, -9223372036854775807L), new S0(0UL, 1, 255, 0, 9223372036854775807L, 10, -8054429149430387324L, 0UL, 5609782809333865024L)}, {new S0(18446744073709551615UL, -127, 1, 126, -2L, 22, -1L, 1UL, 10L), new S0(1UL, 10, 0, 0, 6847262415799052050L, 0, 8614537753627825696L, 0UL, 8381423517238068784L), new S0(1UL, -62, 25, -58, -4520821385966972832L, 245, 1L, 16189335916955109149UL, 0L), new S0(15513812751160975570UL, 28, 254, 127, -9223372036854775807L, 0, -2L, 11792394331972354822UL, 9223372036854775807L), new S0(1UL, 127, 107, 2, 8458230033488262767L, 255, 8794574591777117858L, 3105268869647103430UL, 1203106401373106621L), new S0(0UL, -98, 213, 10, 1L, 165, 10L, 18446744073709551615UL, 6071358001169796902L), new S0(2UL, -25, 65, 42, 8315790491597373845L, 162, 5396067011896130143L, 17492533163551067979UL, 1L), new S0(1UL, -72, 0, 1, 10L, 0, -2L, 0UL, 10L)}});
    }
    ...
    public static ulong M46(S0 arg0)
    {
        ...
        if (!s_21[0][0, 0].F2)
        {
            ...
            if (!s_2[0])
            {
                arg0.F2 = (byte)(-(byte)M47(s_19, s_35[0]));
                arg0.F2 = 207;
            }
            else
            {
                for (int var0 = 0; var0 < 2; var0++)
                {
                    arg0.F8 = M48(ref s_27[0], new S1(32766, 1026270330213543727L, 32767), new int[]{340043196, 581244058, 1, 1971235988}, ref s_34);
                    M47(s_20, s_1[0].F0);
                    s_39 = arg0;
                }
            }
            ...
            arg0.F0 = 18446744073709551614UL;
            for (int var2 = 0; var2 < 2; var2++)
            {
                arg0.F6 = 0L;
                {
                    new S1(-19690, 10L, 32767).M51(new S1(s_18.F0, s_14[0]++, -1).M51(s_23));
                    arg0.F6 = arg0.F8--;
                }
            ...
            if (new S1(-32767, -10L, -25113).M50(new C1(-14885, 65535, 10), 1U))
            {
                ...
                if (!s_1[0].M50(s_46[0], 1990146435U))
                {
                    ...
                    else
                    {
                        ...
                        {
                            s_23.F2 = new S1(10528, 7399665567151049432L, 1).M50(s_46[0], 370574278U);
                            s_39 = new S0(1UL, 1, 124, 65, -1L, 1, -2L, 7173690876284632891UL, 2379675414077985274L);
                            return arg0.F0--;
                        }
                        ...
                        ref C0 var8 = ref s_23;
                        var4 = var4;
                    }
                }
                else
                {
                    arg0.F6 = 9223372036854775807L;
                }

                s_50 = M54(ref arg0.F2, arg0.M55(), 43893, ref arg0).M51(new C0(126, 0, false));
            }
            else
            {
                M47(65534, s_32[0].F0++);
        ...
        arg0.F7 = arg0.F0;
        arg0.F7 ^= 10112974829425217996UL;
        return arg0.F7;
    }
    ...
    public static ref C0 M67(S1 arg0, ushort arg1, C0[][] arg2)
    {
        ...
        byte var11 = default(byte);
        {
            if (arg2[0][0].F2)
            {
                arg2[0][0].F1 /= (byte)(arg2[0][0].F1 | 1);
                arg0 = arg0;
            }
            ...
            if (arg2[0][0].F1 >= (-s_38))
            {
...

                {
                    try
                    {
                        ...
                        arg0.F2 = 32766;
                        s_58 = 0;
                        s_36.F0 = (ulong)((long)(s_24.F7-- + (byte)(arg0.F2 % (byte)(arg2[0][0].F1 | 1))) * var3.F2);
                        M68(var3.F2);
                        arg2 = arg2;
                    ...
                    finally
                    {
                        ...
                        s_33 = s_32[0].F2;
                        arg2[0][0] = M75();
                        arg2[0][0].F0 = arg2[0][0].F0;
                    }

                    M75();
                    {
                        M71(s_24, (uint)(-(uint)new S0(13066284690755382995UL, 39, 39, 1, -6304185142267466735L, 77, 2594057935798786691L, 1UL, 1L).M74(ref arg2[0], s_73.F4)), new C1(2, 37716, 36736), arg2[0][0].F0, new long[][]{new long[]{-9219152107771999994L, 9223372036854775807L}, new long[]{2399550324785436530L, 1L}, new long[]{-7663399696803330267L}, new long[]{-7226288742986198054L}, new long[]{0L, -159522786043129581L, -420750985932956211L, 1L, -968905828793079881L, 1L}}, s_54[0]--, ref s_75);
                        arg0.F2 = s_1[0].F2;
                ...
                arg2[0][0] = s_16;
                {
                    s_6 = new S0(0UL, -64, 255, 43, -9223372036854775808L, 0, 1962981278047476193L, 3011335086183197199UL, 2627595764554707167L);
                    M75() = arg2[0][0];
                    arg1 = 36656;
                }

                s_21[0] = new C0[, ]{{new C0(1, 220, true), new C0(-127, 41, false), new C0(127, 36, true), new C0(105, 45, false)}, {new C0(-71, 163, false), new C0(-2, 248, false), new C0(0, 255, false), new C0(-10, 254, true)}, {new C0(0, 1, false), new C0(-128, 231, false), new C0(25, 0, false), new C0(17, 240, false)}, {new C0(75, 158, true), new C0(126, 62, false), new C0(-68, 0, false), new C0(0, 1, false)}, {new C0(0, 199, true), new C0(-128, 255, false), new C0(-10, 0, true), new C0(-35, 255, true)}, {new C0(-125, 43, true), new C0(124, 180, true), new C0(1, 254, false), new C0(-2, 126, true)}, {new C0(-128, 78, true), new C0(16, 70, false), new C0(-127, 2, true), new C0(127, 104, false)}, {new C0(-87, 96, false), new C0(127, 157, true), new C0(126, 120, false), new C0(-71, 64, false)}, {new C0(-79, 1, true), new C0(-26, 1, true), new C0(-127, 2, false), new C0(60, 95, false)}};
                M70(arg0.F0);
            }
            else
            {
                M68(arg1--);
                ref long var10 = ref arg0.F1;
            }

            s_46[0] = M71(new S0(1UL, 127, 1, 2, 2L, 0, 1L, 6037709778546762483UL, 4697872202077315481L), 4294967295U, s_53, 39, new long[][]{new long[]{-9223372036854775807L, 0L, 6216656006812655468L}, new long[]{0L}, new long[]{1031057642438522248L}, new long[]{9223372036854775807L, 9223372036854775806L, 9223372036854775806L, -631049666848079561L, 9223372036854775806L}}, s_30, ref s_75);
            arg2[0][0].F0 = arg2[0][0].F0;
        }
    ...
    public static ref C1 M71(S0 arg0, uint arg1, C1 arg2, sbyte arg3, long[][] arg4, uint arg5, ref uint[,, ] arg6)
    {
        ...
        if (s_2[0])
        {
            if (arg0.F1 == (s_42[0].F1 % (short)(-32768 | 1)))
            {
                for (int var0 = 0; var0 < 2; var0++)
                {
                    s_45[0] = arg0.F5;
            ...
            s_51 = new S1(24973, -9223372036854775808L, 31645);
            arg3++;
            arg1 = (uint)(arg0.M74(ref s_27, arg4[0][0]) * arg0.M74(ref s_27, s_36.F6));
            if (s_9)
            {
                M73() = 1UL;
            }

            new C0(47, 0, false).M72((short)(-arg2.F0));
            s_60 = arg2.F0--;
            if (s_29[0, 0, 0])
            {
                arg6 = arg6;
                ...
                finally
                {
                    try
                    {
                        s_37 = (long)s_24.M74(ref s_27, -7097740965636272191L);
                    }
                    finally
                    {
        ...
        {
            new S0(1UL, -81, 0, -10, 6589252819518358104L, 0, -7118351756116252788L, 18446744073709551615UL, 0L).M74(ref s_27, (long)arg0.M74(ref s_27, arg0.F4));
            if (s_27[0].F2)
            {
                arg2 = s_32[0];
                new S0(1UL, -3, 254, 16, 1485501850850961647L, 254, 9223372036854775806L, 1UL, 384975569988194764L).M74(ref s_27, s_37);
            }
        ...
        s_26[0] = arg2.F1;
        {
            ...
            if (s_21[0][0, 0].F2)
            {
                arg0 = new S0(1UL, -35, 141, 92, 1L, 113, 6166332110340028992L, 2UL, 2L);
            }

            if (s_29[0, 0, 0])
            {
                {
                    arg0.M74(ref s_27, arg0.F4);
                    s_62 = -2L;
                    arg0.M74(ref s_27, arg0.F6);
                    arg0.F4--;
                    s_63 = new S0(18446744073709551614UL, 2, 125, 0, 0L, 255, -9223372036854775808L, 7992269718514799196UL, 1L);
...

        {
...

            {
                ...
                var19 = arg2.F1;
                {
                    ...
                    {
                        {
                            M77(ref arg3, ref s_51, M79((ushort)((-var15[0][0]) >> (short)M73())), arg0.F7, ref s_45);
                            M73()++;
                            arg0 = arg0;
                        }

                        new C0(-54, 140, false).M76(ref s_32[0].F1).M78();
                    }

                    M79(1);
                    arg2 = arg2;
                    s_6.F8 = (long)((ushort)(var19 >> s_6.M78()) << (s_51.F0 + arg0.F2));
                    arg0.F7 = arg0.F7;
                    arg5 = (uint)(arg2.F0 / (byte)((byte)M73() | 1));
    ...
    public static bool M90()
    {
        ...
        if (!!s_70)
        {
            try
            {
                new C0(-110, 192, false).M108(s_81, 4152253806U).M91(1);
            }
            finally
            {
                ref C0 var1 = ref s_86;
            }
            ...
            {
                s_111 = new ulong[,, ]{{{6739315731942248795UL, 12908496212045280651UL, 0UL, 1UL}, {1UL, 7943382727225691089UL, 7508281132040874935UL, 8762340052218923398UL}, {1UL, 2154637957950849472UL, 1UL, 18446744073709551614UL}, {10UL, 911115390804151377UL, 0UL, 1UL}, {1UL, 8861539305976042508UL, 834089801323266526UL, 11809406209707012832UL}, {6070196779998314412UL, 14269639165082353908UL, 18446744073709551615UL, 0UL}, {0UL, 8122773724235100827UL, 2UL, 1UL}, {10UL, 1UL, 6957009580468090538UL, 4358841347814080193UL}, {10184172949423117069UL, 0UL, 13811928069825102718UL, 1UL}, {0UL, 11317372344342877498UL, 18446744073709551615UL, 10241846290849554890UL}}, {{0UL, 18446744073709551614UL, 6602855733548158060UL, 770269207607096415UL}, {3917649248210758689UL, 18446744073709551614UL, 7819071271076466208UL, 10UL}, {18446744073709551615UL, 0UL, 1UL, 5052152682179497811UL}, {0UL, 6689714864371156837UL, 16092618428069036241UL, 18446744073709551615UL}, {725959863835847343UL, 16951209025480213602UL, 15848788745181172941UL, 1908077594481362528UL}, {0UL, 9700329555206696686UL, 0UL, 1797525967983780654UL}, {4432910156017178137UL, 1UL, 18248080890099455972UL, 1UL}, {6359277060237000312UL, 0UL, 0UL, 18446744073709551615UL}, {11785895224703735258UL, 17178008006491294409UL, 8345901313194115013UL, 18446744073709551614UL}, {6875867550191871346UL, 8823956842132177971UL, 18446744073709551615UL, 17582363636023699001UL}}};
                s_6.F0 = (ulong)new C0(0, 255, true).M105(s_16.F0, new S1[]{new S1(3766, 1L, 2263), new S1(-21526, 6108647165051621171L, 28004), new S1(29686, 4285591595834105903L, -23641), new S1(31228, -10L, 32767), new S1(-20334, 10L, 1), new S1(2, 1L, 0)}, (byte)s_18.M107(ref s_18));
            }
        }

        for (int var5 = 0; var5 < 2; var5++)
        {
            ref short var6 = ref s_99[0];
        }
        ...
        M101();
        new C1(1, 43242, 21139).M99(0U) = (short)(~(short)M100((short)(35 ^ (long)s_86.M105(s_101[0, 0].F3--, s_1, (byte)new S1(-32768, 295912082359021056L, -31429).M98(new S1(0, 9223372036854775807L, -17859), 10, new uint[, ]{{2080012312U, 3243154115U, 3958934075U, 155745611U, 0U, 0U, 1U, 1201414600U, 1U}, {0U, 1U, 289913394U, 170457984U, 0U, 4294967294U, 2U, 1U, 493975970U}, {1898155649U, 2074868651U, 3310335926U, 4080021609U, 0U, 3672499146U, 4294967295U, 0U, 3457884471U}, {1U, 280106853U, 3838011814U, 3192668187U, 3039681442U, 2920852974U, 1U, 10U, 1793470241U}}, s_103, 1)))));
        if (M110(ref s_12))
        {
            try
            {
        ...
        var0 >>= (int)(s_28.M107(ref s_28) & s_30);
        {
        ...
        {
            s_114 = s_24.F5;
            ref uint var11 = ref s_107;
            var11 = (uint)(-s_25[0][0]--);
        }
        else
        {
            M93(s_95);
            M113(ref var0, new C0(2, 9, false));
        }
        ...
        if (!M110(ref s_12))
        {
            ...
            else
            {
                ...
                {
                    var13.F1 = var15.F0;
                    new S1(-19723, 0L, 2).M98(new S1(-1, 8373286692595823570L, -11854), var12.F0, new uint[, ]{{2U, 2793870323U, 4171164406U, 2265946829U}, {1326909707U, 4294967295U, 1U, 1U}, {0U, 2997963018U, 1U, 113339524U}, {1U, 3390837468U, 287884620U, 3442319902U}}, 15576447675144287177UL, -2057493338) = s_58;
                }
                else
                {
                    M113(ref var0, new C0(s_73.F3, (byte)(261946321U | s_92), var15.F2));
                    var12.F2 = var12.F2;
                    var0 = (ushort)(var0 + (uint)(var12.F0 << var12.F0));
                    if (var15.F2)
                    {
                        M110(ref s_107);
        ...
        if (s_70)
        {
            var21 = M110(ref s_107);
            {
                ...
                {
                    M111(45, new ulong[]{16924682121700311429UL, 18446744073709551614UL, 15607595854109028049UL, 1UL, 0UL, 0UL, 14609169409396382093UL, 0UL, 2304576438984324402UL, 2UL}, var21, M95(s_48++, new int[]{-2147331177, 618467039, -1677189581, 2147483647, 515143234, 436645730, 1871962342, -2147483648, 1}), ref s_45, new bool[]{false}, new S1(1, -2L, 30851));
                    var22 = var22;
                }
        ...
        if (s_86.F2)
        {
            if (M110(ref var28))
            {
                ref short var31 = ref var29.F0;
                var31 = var12.F0;
                var29 = M95(10, new int[]{1, 1});
            }
            else
            {
                var29.F0 = 0;
                s_1[0].M98(new S1(-3776, 9223372036854775807L, 7396), var29.F0, new uint[, ]{{1U, 10U, 519244502U, 1U, 0U, 2U, 1123201786U, 1U}}, 1UL, s_74++) = (int)M101();
                var0 = var12.F2;
            }
        }
        else
    ...
    public static long M92()
    {
        ...
        try
        {
            s_89 = new S0(2UL, -100, 255, 0, -8938565090588793296L, 0, 9223372036854775806L, 1UL, 9223372036854775807L);
            {
                ...
                if ((sbyte)(-(sbyte)(~s_6.F3)) >= 1U)
                {
                    ...
                    {
                        M93(new byte[]{1, 120});
                        s_17.F0 = (short)new S1(1955, -8476288833170601803L, 14504).M98(new S1(32767, 2L, 10963), (short)(15643564013386320279UL / (byte)(s_21[0][0, 0].F1 | 1)), new uint[, ]{{1697435828U, 124638974U, 0U, 4294967295U, 1052934907U, 259798753U, 159755342U, 4294967295U, 0U}, {0U, 4294967295U, 1542037326U, 0U, 0U, 4294967294U, 2U, 4294967295U, 967663816U}, {1U, 2914696410U, 1U, 935075796U, 2669559950U, 4294967294U, 2247136579U, 1733693510U, 3879577542U}, {338554789U, 666822547U, 4294967294U, 0U, 3345747190U, 657887563U, 3754713244U, 0U, 4294967295U}, {2423455018U, 2754050351U, 10U, 1033271757U, 3922426943U, 4294967294U, 4294967294U, 1U, 1U}, {4176642878U, 2130904244U, 4294967295U, 3979749395U, 4134451561U, 4068919269U, 1U, 1U, 4294967295U}, {4037794914U, 3044759336U, 4294967294U, 2541431095U, 3761614795U, 2085575176U, 2154898948U, 0U, 1622948555U}, {3646663976U, 0U, 2243047679U, 466308462U, 1U, 2562965104U, 360993973U, 1145639640U, 2052797900U}, {1755859749U, 4294967294U, 381972537U, 1U, 1U, 3090245257U, 3004143903U, 3121938625U, 1U}}, ~s_90, 2039717922);
                        M104();
                        new S1(-32767, 2000391488623143925L, 20910).M107(ref s_1[0]);
                        s_1[0].M98(new S1(-8074, 8036381969263820198L, 1233), (short)(~s_1[0].F2), new uint[, ]{{0U, 1U, 349382790U, 4001843585U, 1U}, {2U, 0U, 1U, 2417032484U, 1U}, {3726345671U, 2635227769U, 2U, 1995477682U, 3185482691U}, {178413094U, 2004048393U, 3514663710U, 2U, 2148488020U}, {134332883U, 4294967294U, 154814072U, 0U, 2760120377U}}, (ulong)M93(new byte[]{192, 0, 255, 71, 254}), (int)M100(s_51.F0--)) = -1274545482;
                        s_98 = 16260446378276264352UL;
                        ref ulong var5 = ref s_24.F0;
                    }
                ...
                {
                    if (M110(ref s_75[0, 0, 0]))
                    {
                        s_84.M94();
                        s_21[0][0, 0].M105(19, new S1[]{new S1(31601, 2011068212528915582L, 32766)}, 115);
                        M101();
                        var0 = var0;
                        var8 *= (uint)M95((byte)((ushort)(~var0) - 255), new int[]{-1932955935, 930340476, -1972472644, 0, 0, 1}).M99(var8++);
                    }
                    else
                    {
                        var8 = 3492496030U;
        ...
        finally
        {
            ...
            finally
            {
                if (M110(ref s_54[0]))
                {
                    if (M110(ref s_54[0]))
                    {
                        s_87 = (long)M113(ref s_46[0].F1, new C0(-13, 1, false));
                        s_6.F5 = 55;
                    }

                    if (!M110(ref s_75[0, 0, 0]))
                    {
                        s_102 |= (byte)new S1(1, -3998329455337470200L, -19862).M107(ref s_79) == s_42[0].F3--;
                        s_103 = s_59;
                        ref C1 var11 = ref s_46[0];
                        if (s_22)
                        {
                            var11.F0 = s_1[0].F0;
                            var12 = s_21[0][0, 0].F0--;
                        ...
                        {
                            ref byte var14 = ref s_42[0].F2;
                            var11.F1 += (ushort)M113(ref var11.F2, new C0(-7, 102, false));
                            s_24 = M114(ref s_50.F2, new I0[]{new S0(18230182792900078760UL, -12, 0, -128, 0L, 1, 9223372036854775806L, 11363702866645726859UL, -9223372036854775807L), new S0(18446744073709551615UL, -128, 0, 33, 2113417722715718321L, 188, -10L, 15398665130926806702UL, 9223372036854775806L), new S0(2UL, 31, 254, 112, 1L, 48, 1L, 3286632984851261517UL, -2L), new S0(7700111699547457043UL, 38, 237, 1, -9223372036854775807L, 10, 1196478188003198174L, 12777469932825552376UL, 1L), new S0(0UL, -119, 1, 42, 1L, 1, 7274105537157141181L, 18446744073709551614UL, 10L), new S0(6456592084531580968UL, -71, 191, -93, 9223372036854775806L, 0, 5960216179671565639L, 6084449612258161284UL, 2L), new S0(2UL, -127, 0, -38, -9223372036854775807L, 1, -1072119950582157874L, 18000247456665761482UL, 0L), new S0(17096037515156582616UL, 67, 254, -55, -9223372036854775808L, 138, 8446282505443815688L, 4181272321565264352UL, -2L), new S0(18305459612593999169UL, -1, 0, 10, 9223372036854775807L, 1, 1L, 0UL, 619968766259811823L)}, -42, new uint[, ]{{2U, 1U, 4294967294U}, {2320350186U, 3741340634U, 1U}}, s_17.F2);
                            M113(ref var11.F2, s_84);
                            ref S1 var15 = ref s_1[0];
                            s_5[0][0, 0, 0].F1 = var11.F1;
                            var15 = ref var15;
                            var11.M99(0U);
                        }

                        s_104 = s_11[0, 0]++;
                        new S1(-32767, 2425872177752722499L, 2395).M98(new S1((short)M100(var11.F0), M101(), var11.M99(s_54[0]--)), (short)((short)new S1(2, -9223372036854775808L, -24625).M98(s_17, var11.F0, new uint[, ]{{466041430U, 2091867195U, 1U, 1U}}, s_101[0, 0].F7++, s_76) ^ (long)M113(ref var11.F2, new C0(104, 182, true))), new uint[, ]{{2100541428U, 1792179664U, 1U, 1158136560U, 1U, 4294967294U, 4294967295U, 3492296734U, 2475891192U}, {2986574491U, 0U, 0U, 1499673966U, 3937777368U, 1846191113U, 1U, 0U, 3765895205U}, {1287651467U, 1U, 0U, 0U, 1U, 1660301173U, 1733683923U, 0U, 1U}}, 4247126683771029421UL, 1985709965) = ~~s_92--;
                        new S1(32766, -7190116438680151602L, -32768).M107(ref s_17);
                        ref short var16 = ref var11.F0;
                        try
                        {
                            var11.F2 = var11.F1--;
                        }
                    ...
                    {
                        s_32 = s_46;
                        new S0(170769298949267034UL, -127, 121, 14, -739293562670211174L, 10, 4573352361643701017L, 13048396038522759309UL, 1L).M97(new S1(32767, -6717916375222847755L, -2747));
                        new S1(6700, -9223372036854775808L, -32768).M103();
                        s_42[0].F3 = s_16.F0++;
                        s_4 ^= s_6.F7;
                    }

                    s_101[0, 0].F2 = (byte)new S1(0, -837675155660594054L, 1).M98(new S1(-14800, -7478289310529738635L, 32767), 31670, new uint[, ]{{1U, 2767114902U, 3581673514U, 1003890070U, 10U, 3634070773U, 0U}, {10U, 4294967295U, 4294967295U, 1899803745U, 2475030721U, 3717463854U, 1579825647U}, {743143103U, 1U, 840005701U, 3843745835U, 3773695170U, 858107239U, 1485814303U}, {1938515471U, 1472862144U, 1U, 1U, 0U, 0U, 1U}, {2740011956U, 4253265297U, 0U, 2527911764U, 3070626078U, 3861782027U, 4294967295U}, {0U, 1U, 60697397U, 0U, 0U, 2441476772U, 1U}, {0U, 1555826388U, 4294967295U, 1232213188U, 1614200571U, 957079441U, 2U}, {1399239923U, 0U, 0U, 267149216U, 3121055368U, 1U, 1197258903U}}, s_42[0].F0--, s_38);
                    s_100 = new ushort[][]{new ushort[]{1, 61235, 2, 13446, 1, 1933, 0}, new ushort[]{34831, 0, 0}, new ushort[]{65534, 65535, 0, 50132, 20328}, new ushort[]{51365, 55225, 1, 10643, 0}, new ushort[]{0, 59659}, new ushort[]{6197, 1, 16448, 1, 20637, 2}};
                    s_42[0].F4 = (long)s_5[0][0, 0, 0].M99((uint)(s_1[0].F2 ^ -9223372036854775807L));
                    s_101[0, 0].F7 = 17133937556264620178UL;
                }
        ...
        for (int var20 = 0; var20 < 2; var20++)
        {
            s_106 = new C1(6346, 65534, 65534);
            M95((byte)(-(byte)((int)((s_88[0].F0 & s_36.F6++) | s_12) >> (byte)(-30183 * var20))), new int[]{2078007180});
            s_72 = (byte)M113(ref s_46[0].F1, new C0(-1, 254, true));
            s_107 = (uint)M93(new byte[]{218, 0, 10, 189, 122});
        }
